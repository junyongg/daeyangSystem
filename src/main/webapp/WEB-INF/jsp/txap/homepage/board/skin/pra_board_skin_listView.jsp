						...
						<div class="widget-body" >
							...
							<div class="table-responsive">
								<jsp:include page="/WEB-INF/jsp/txap/include/search/pra_search_header_paging.jsp" flush="true">
									<jsp:param value="/txap/homepage/board/skin/boardSkinAjax.do" name="pagingDataUrl" />
								</jsp:include>
...
function pf_boardTemplateUpdate(key) {
	$("#BST_KEYNO").val(key);
	$("#type").val('update');
	$("#Form").attr("action", "/txap/homepage/board/skin/boardSkin_InsertView.do");
	$("#Form").submit();
} 
...
function pf_PublishFile(key){
	...
	if(confirm(msg)) {
		...
		$.ajax({
		    type   : "post",
		    url    : "/txap/homepage/board/skin/boardSkinDistributeAjax.do",
		    data   : {"BST_KEYNO" : key},
		    async  : false ,
