...
<link rel="stylesheet" type="text/css" media="all" href="/resources/common/css/txap/layout.css">
<script type="text/javascript" src="/resources/common/js/txap/jquery.easing.1.3.js"></script>
<script type="text/javascript" src="/resources/common/js/txap/common.js"></script>
<script type="text/javascript" src="/resources/common/js/txap/Chart.min.js"></script>
<script type="text/javascript" src="/resources/common/js/txap/utils.js"></script>
<script>
var msg = '${msg}'
var homeKey = '${homeKey}'
...
function getCategoryListAjax(mainCategory,obj){
	...
	$.ajax({
		type : "post",
		url  : "/txap/main/DataList/DataAjax.do", 
...
<section id="dash-in-box">
 	<sec:authorize url="/txap/homepage/board/dataView.do">
	...
	<sec:authorize url="/txap/admin/keyword.do">
		<div class="one co-2 n01 r03 categoryWrap" id="categoryWrap3"></div>
	</sec:authorize>
	<sec:authorize url="/txap/homepage/research/pageComment.do">
	...
	<sec:authorize url="/txap/statistics/visitor.do">
