package com.tx.txap.homepage.organization.controller;
...
import com.tx.txap.homepage.organization.service.OrganizationService;
...
public class OrganizationController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/org.do")
	...
	public ModelAndView organizationView(HttpServletRequest req, OrganDTO OrganDto, Menu Menu,
		...
		ModelAndView mv = new ModelAndView("/txap/homepage/organ/pra_organ_listView.adm");
	...
	@RequestMapping(value = "/txap/homepage/org/empl.do")
	...
	public ModelAndView employeeView(HttpServletRequest req, OrganDTO OrganDto, Menu menu) throws Exception {
		ModelAndView mv = new ModelAndView("/txap/homepage/organ/pra_organ_member_list.adm");
	...
	@RequestMapping(value = "/txap/person/view/organPagingAjax.do")
	public ModelAndView adminMemberViewPaging(HttpServletRequest req, Common search
	) throws Exception {

		ModelAndView mv = new ModelAndView("/txap/homepage/organ/pra_organ_member_list_data");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/dataAjax.do")
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/data2Ajax.do")
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/insert.do")
	...
	public ModelAndView adminOperationOrgInsert(HttpServletRequest req, HttpServletResponse res,
		...
		if (OrganDto.getDN_MAINKEY() == "") {
			...
			if (mainCnt > 0) {
				...
				out.println("alert('최상위 조직은 하나만 등록가능합니다.'); location.href='/txap/homepage/org/org.do'");
				out.println("</script>");
				out.flush();
				return null;
			}else{
		...
		ModelAndView mv = new ModelAndView(
				"redirect:/txap/homepage/org/org.do?key=" + key + "&MN_HOMEDIV_C=" + OrganDto.getDN_HOMEDIV_C()+"&DIV_KEY=111");
		return mv;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/update.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/delete.do")
	...
	public ModelAndView adminOperationOrgDelete(HttpServletRequest req, OrganDTO OrganDto) throws Exception {
		...
		ModelAndView mv = new ModelAndView(
				"redirect:/txap/homepage/org/org.do?" + "MN_HOMEDIV_C=" + OrganDto.getDN_HOMEDIV_C()+"&DIV_KEY=111");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/person/insert.do")
	...
	public ModelAndView adminOperationOrgPersonInsert(HttpServletRequest req, OrganDTO OrganDto) throws Exception {
		...
		if(req.getParameter("PAGE_DIV_C") != null){
			ModelAndView mv = new ModelAndView(
				"redirect:/txap/homepage/org/empl.do?key=" + key + "&MN_HOMEDIV_C=" + OrganDto.getDU_HOMEDIV_C());
			return mv;
		}else{
			ModelAndView mv = new ModelAndView(
					"redirect:/txap/homepage/org/org.do?key=" + key + "&MN_HOMEDIV_C=" + OrganDto.getDU_HOMEDIV_C()+"&DIV_KEY=111");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/person/update.do")
	...
	public ModelAndView adminOperationOrgPersonUpdate(HttpServletRequest req, OrganDTO OrganDto) throws Exception {
		...
		if(req.getParameter("PAGE_DIV_C") != null){
			ModelAndView mv = new ModelAndView(
					"redirect:/txap/homepage/org/empl.do?MN_HOMEDIV_C=" + OrganDto.getDU_HOMEDIV_C());
				return mv;
			}else{
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/person/delete.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/person/chageLev.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/person/chageLev2.do")
	@CheckActivityHistory(desc = "조직원 순서 변경 작업", homeDiv = SettingData.HOMEDIV_ADMIN)
	@Transactional
	@ResponseBody
	 ...
	 * 
	 */
	@RequestMapping(value = "/txap/homepage/org/excelAjax.do")
	public ModelAndView adminOperationExcelAjax(HttpServletResponse res, Model model,
		...
		ModelAndView mv = new ModelAndView("/txap/homepage/organ/pra_organ_list_excel");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/operation/empl/excelAjax.do")
	public ModelAndView adminMemberViewExcelAjax(HttpServletRequest req
		...
		ModelAndView mv  = new ModelAndView("/txap/homepage/organ/pra_organ_member_list_excel");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/excelInsertAjax.do")
	@ResponseBody
	@Transactional
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/org/excelDownload.do")
