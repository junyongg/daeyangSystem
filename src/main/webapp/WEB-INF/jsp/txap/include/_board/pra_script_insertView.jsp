...
function success(){
	cf_replaceTrim($("#Form"));
	if(action == 'insert'){
		$("#Form").attr("action", "/txap/homepage/board/data/action.do?${_csrf.parameterName}=${_csrf.token}");
	}else if(action == 'update'){
		$("#Form").attr("action", "/txap/homepage/board/data/action.do?${_csrf.parameterName}=${_csrf.token}");
	}else if(action == 'move'){
		$("#Form").attr("action", "/txap/homepage/board/data/move.do?${_csrf.parameterName}=${_csrf.token}");
	}else{
