package com.tx.txap.admin.ipfilter.controller;
...
public class IpfilerController {
	...
	@RequestMapping(value="/txap/admin/ipfilter.do")
	@CheckActivityHistory(desc="IP화이트/블랙리스트 페이지 방문")
	public ModelAndView ipFilter(HttpServletRequest req
			) throws Exception {
		
		
		ModelAndView mv  = new ModelAndView("/txap/admin/ipfilter/pra_ipfilter.adm");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/admin/ipfilter/error.do")
	public ModelAndView ipFilterError(HttpServletRequest request) throws Exception {
		
		ModelAndView mv  = new ModelAndView("/txap/admin/ipfilter/error");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/admin/ipfilter/main/insert.do")
	...
	public ModelAndView ipFilterMainAdd(@ModelAttribute IP IP
		...
		ModelAndView mv  = new ModelAndView("redirect:/txap/admin/ipfilter.do");
	...
	@RequestMapping(value="/txap/admin/ipfilter/main/updateAjax.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/admin/ipfilter/main/deleteAjax.do")
	...
	@RequestMapping(value="/txap/admin/ipfilter/subList/listAjax.do")
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/admin/ipfilter/sub/insert.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/admin/ipfilter/sub/updateAjax.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/admin/ipfilter/sub/deleteAjax.do")
