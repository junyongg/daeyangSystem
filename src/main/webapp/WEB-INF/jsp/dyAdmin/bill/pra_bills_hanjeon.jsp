...
<input type="hidden" name="dbp_subkey1" id="dbp_subkey1" value = "1">
<input type="hidden" name="dbs_subkey1" id="dbs_subkey1" value = "1">
							...
							<div class="tableMobileWrap">
								<table id="dt_basic"
									...
									<tbody style="text-align: center;">
										<c:if test="${empty loglist1 }">
											<tr>
												<td colspan="7">검색된 데이터가 없습니다.</td>
											</tr>
										</c:if>
										<c:forEach items="${loglist1 }" var="b">
											<tr>
