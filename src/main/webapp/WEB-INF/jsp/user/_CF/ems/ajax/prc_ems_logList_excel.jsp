...
<%
	String fileName = "실시간 로그 리스트.xls";
...
<body>
	...
	<table>
		<thead>
			<tr></tr>
			<tr class="background">
				<th colspan="${colspan}" class="title">로그 관리 리스트</th>
			</tr>
			<tr></tr>
			<tr>
	...
	<table id="dt_basic">
		...
		<tbody>
			<c:forEach items="${resultList }" var="l" varStatus="status">
				<tr>
					<td>${l.IO_DATE }</td>
					<td><span class="log">STATUS - ${l.IO_STATUS } &nbsp;&nbsp; | &nbsp; Current_Power : ${l.IO_POWER },&nbsp; Current_Usage : ${l.IO_USAGGE } ,&nbsp; 절감수익 : ${l.IO_CASH },&nbsp; Co2절감량 : ${l.IO_CO2 }</span></td>
				</tr>
			</c:forEach>
		</tbody>
	</table>