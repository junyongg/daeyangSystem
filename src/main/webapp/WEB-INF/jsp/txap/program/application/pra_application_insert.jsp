			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0"
				...
				<div>
					...
					<div class="widget-body">
						...
						<footer> 
							<button class="btn btn-sm btn-default" type="button" onclick="cf_back('/txap/program/application/application.do')"> 
...
var functionName = '';
	...
	if(confirm(type+"하시겠습니까?")){
		functionName();
		cf_replaceTrim($("#Form"));
		$('#Form').attr('action','/txap/program/application/action.do');
		$('#Form').submit();
	}
}
