...
public class BoardController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/dataView.do")
	...
	public ModelAndView BoardDataListView(
		...
		ModelAndView mv = new ModelAndView("/txap/homepage/board/data/pra_board_data_listView.adm");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/dataView/pagingAjax.do")
	public ModelAndView BoardDataListViewPagingAjax(
		...
		ModelAndView mv = new ModelAndView("/txap/homepage/board/data/pra_board_data_listView_data");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/dataView/excelAjax.do")
	public Object BoardDataListViewExcelAjax(
		...
		ModelAndView mv = new ModelAndView("/txap/homepage/board/data/pra_board_data_listView_excel");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/data/main/menu/selectAjax.do")
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/data/actionView.do")
	...
	public ModelAndView BoardDataActionView(
		...
		ModelAndView mv = new ModelAndView("/txap/homepage/board/data/pra_board_data_insertView.adm");
		...
		mv.addObject("Menu", Menu);
		mv.addObject("mirrorPage", "/txap/homepage/board/dataView.do");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/data/action.do")
	@CheckActivityHistory(type = "hashmap", homeDiv = SettingData.HOMEDIV_ADMIN)
	@Transactional
	public ModelAndView BoardDataAction(
		...
		//개인정보필터 재확인
		String returnUrl = BoardCommonService.boardPersonalCheck(response, boardType,ConTents,"/txap/homepage/board/dataView.do?MN_KEYNO="+BoardNotice.getBN_MN_KEYNO());
		if (StringUtils.isNotBlank(returnUrl)) {
			mv.setViewName(returnUrl);
			return mv;
		}
		mv.setViewName("redirect: /txap/homepage/board/dataView.do?MN_KEYNO=" + BoardNotice.getBN_MN_KEYNO());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/data/detailView.do")
	@CheckActivityHistory(type = "hashmap", homeDiv = SettingData.HOMEDIV_ADMIN)
	public ModelAndView BoardDataDetailView(
			...
			,@ModelAttribute Menu Menu
			, HttpServletRequest req) throws Exception {
		ModelAndView mv = new ModelAndView("/txap/homepage/board/data/pra_board_data_detailView.adm");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/data/detailView/comment/pagingAjax.do")
	public ModelAndView boardTypeViewPagingAjax(HttpServletRequest req, Common search, @RequestParam String BC_BN_KEYNO)
			throws Exception {

		ModelAndView mv = new ModelAndView("/txap/homepage/board/data/pra_board_data_detailView_comment_data");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/data/detailView/comment/excelAjax.do")
	public ModelAndView boardTypeViewExcelAjax(HttpServletRequest req, HttpServletResponse res, Common search,
		...
		ModelAndView mv = new ModelAndView("/txap/homepage/board/data/pra_board_data_detailView_comment_excel");
	...
	@RequestMapping(value = "/txap/homepage/board/data/updateView/listAjax.do")
	@ResponseBody
	...
	@RequestMapping(value = "/txap/homepage/board/data/state.do")
	@CheckActivityHistory(type = "hashmap", homeDiv = SettingData.HOMEDIV_ADMIN)
	@Transactional
	public ModelAndView BoardDataDelete(@ModelAttribute BoardNotice BoardNotice, @RequestParam (value="delComplete", required=false) boolean delComplete, HttpServletRequest req)
			throws Exception {
		ModelAndView mv = new ModelAndView("redirect: /txap/homepage/board/dataView.do?MN_KEYNO=" + BoardNotice.getBN_MN_KEYNO());
		if(delComplete) mv.setViewName("redirect:/txap/homepage/board/deleteView.do");
		Menu Menu = new Menu();
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/moveView.do")
	@CheckActivityHistory(type = "hashmap", homeDiv = SettingData.HOMEDIV_ADMIN)
	public ModelAndView boardDataMoveView(HttpServletRequest req, BoardType BoardType, BoardNotice BoardNotice,
		...
		ModelAndView mv = new ModelAndView("/txap/homepage/board/data/pra_board_data_moveView.adm");
		Menu.setMN_KEYNO(BoardNotice.getBN_MN_KEYNO());
		Menu = Component.getData("Menu.AMN_getMenuByKey", Menu);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/moveCheckAjax.do")
	@ResponseBody
	...
	@RequestMapping(value = "/txap/homepage/board/moveView2.do")
	@CheckActivityHistory(type = "hashmap", homeDiv = SettingData.HOMEDIV_ADMIN)
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/data/move.do")
	@CheckActivityHistory(type = "hashmap", homeDiv = SettingData.HOMEDIV_ADMIN)
	@Transactional
	public ModelAndView boardDataMove(@ModelAttribute BoardType BoardType, @ModelAttribute BoardColumn BoardColumn,
		...
		ModelAndView mv = new ModelAndView(
				"redirect:/txap/homepage/board/data/detailView.do?BN_KEYNO=" + BoardNotice.getBN_KEYNO());
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/data/reply/insertView.do")
	public ModelAndView ReplyInsertView(@RequestParam(value = "BN_KEYNO", required = false) String BN_KEYNO,
			HttpServletRequest req) throws Exception {
		ModelAndView mv = new ModelAndView("/txap/homepage/board/reply/pra_board_reply_insertView.adm");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/data/comment/deleteAjax.do")
	...
	@RequestMapping(value = "/txap/homepage/board/data/detailView/compareAjax.do")
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/data/detailView/historyContents.do")
	...
	@RequestMapping(value = "/txap/homepage/board/data/restore.do")
	...
	public ModelAndView restore(@ModelAttribute BoardColumnData BoardColumnData,
		...
		ModelAndView mv = new ModelAndView("redirect:/txap/homepage/board/data/detailView.do?BN_KEYNO=" + bn_keyno);
	...
	@RequestMapping(value="/txap/homepage/board/{key:[\\d]+}/deleteView.do")
	...
	public ModelAndView boardDataDeleteView(HttpServletRequest req
		...
		ModelAndView mv =new ModelAndView("/txap/homepage/board/data/pra_board_data_deleteView.adm");
		Menu = Component.getData("Menu.AMN_getMenuByKey", Menu);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/deleteView.do")
	@CheckActivityHistory(desc = "게시물 삭제대장 페이지 방문")
	public ModelAndView BoardDataDeleteView(
			  HttpServletRequest req
			, Menu Menu
			) throws Exception {
		ModelAndView mv = new ModelAndView("/txap/homepage/board/data/deleteView/pra_board_data_del_listView.adm");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/deleteView/pagingAjax.do")
	public ModelAndView BoardDataDeleteListViewPagingAjax(
			HttpServletRequest req
			, Common search
			) throws Exception {
			
		ModelAndView mv = new ModelAndView("/txap/homepage/board/data/deleteView/pra_board_data_del_listView_data");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/board/deleteView/excelAjax.do")
	public Object BoardDeleteListViewExcelAjax(
			  HttpServletRequest req
			, HttpServletResponse res
			, Common search
			, @RequestParam(value = "MN_NAME", required = false) String MN_NAME) throws Exception {
		ModelAndView mv = new ModelAndView("/txap/homepage/board/data/deleteView/pra_board_data_del_listView_excel");
