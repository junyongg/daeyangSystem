						...
						<div class="widget-body " >
							...
							<div class="table-responsive">
								<jsp:include page="/WEB-INF/jsp/txap/include/search/pra_search_header_paging.jsp" flush="true">
									<jsp:param value="/txap/homepage/board/MainMiniBoardView/pagingAjax.do" name="pagingDataUrl" />
...
function pf_boardTypeUpdate(key) {
	$("#BMM_KEYNO").val(key);
	$("#Form").attr("action", "/txap/homepage/board/MainMiniBoard/updateView.do");
	$("#Form").submit();
} 

//미니게시판 등록페이지 이동 
function pf_MainMiniRegist() {
	$("#Form").attr("action", "/txap/homepage/board/MainMiniBoard/insertView.do");
	$("#Form").submit();
}
...
function pf_PublishFile(key){
	...
	if(confirm(msg)) {
		...
		$.ajax({
		    type   : "post",
		    url    : "/txap/homepage/board/MainMiniBoard/publishAjax.do",
		    data   : {"BMM_KEYNO" : key},
		    async  : false ,
