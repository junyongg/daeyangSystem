...
<script type="text/javascript">
	...
	$(document).ready(function() {
		...
		$("#cf_list").on("click", function(){
			location.href="/txap/admin/code.do";
		});
	...
	function pf_insertSuccess(){
		...
		$.ajax({
			type: "POST",
			url: "/txap/admin/code/sub/insertAjax.do",
			data: {
	...
	function pf_updateSuccess(){
		...
		$.ajax({
			type: "POST",
			url: "/txap/admin/code/sub/updateAjax.do",
			data: {
				"SC_KEYNO" : SC_KEYNO,
	...
	function pf_delSuccess(a){
		...
		$.ajax({
			type: "POST",
			url: "/txap/admin/code/sub/deleteAjax.do",
			data: formData,
			success : function(){
				 callBack(data);
			},
	...
	function pf_maincodeedit(){
		...
		$.ajax({
			type: "POST",
			url: "/txap/admin/code/main/update.do",
			data: formData,
			success : function(){
	...
	function pf_mcDelete(mc_keyno, mc_ic_c){
		if(confirm("메인코드를 삭제하시겠습니까?")){
			...
			$("#MC_IN_C").val(mc_ic_c);
			$("#Form").attr("action","/txap/admin/code/main/delete.do");
			$("#Form").submit();
		}
	}
