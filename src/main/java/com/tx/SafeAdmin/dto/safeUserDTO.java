...
public class safeUserDTO {
	...
	public String getSU_DPP_KEYNO() {
		return SU_DPP_KEYNO;
	}
	public void setSU_DPP_KEYNO(String sU_DPP_KEYNO) {
		SU_DPP_KEYNO = sU_DPP_KEYNO;
	}
