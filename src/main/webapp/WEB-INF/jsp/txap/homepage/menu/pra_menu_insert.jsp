...
<%@ include file="/WEB-INF/jsp/txap/homepage/menu/script/pra_menu_list_insert_script.jsp" %>
<%@ include file="/WEB-INF/jsp/txap/homepage/menu/script/pra_menu_list_authority_script.jsp" %>
<%@ include file="/WEB-INF/jsp/txap/homepage/menu/script/pra_menu_list_move_script.jsp" %>
