							...
							<div class="widget-body">
								...
								<div class="table-responsive">
									<jsp:include page="/WEB-INF/jsp/txap/include/search/pra_search_header_paging.jsp" flush="true">
										<jsp:param value="/txap/homepage/board/dataView/pagingAjax.do" name="pagingDataUrl" />
										<jsp:param value="/txap/homepage/board/dataView/excelAjax.do" name="excelDataUrl" />
									</jsp:include>
...
function pf_RegistMove() {
	...
	$("#Form").attr("action", "/txap/homepage/board/data/actionView.do");
	$("#Form").submit();
}
...
function pf_HtmlRegistMove(){
	$("#Form").attr("action","/txap/homepage/board/data/html/insertView.do");
	$("#Form").submit();
}
