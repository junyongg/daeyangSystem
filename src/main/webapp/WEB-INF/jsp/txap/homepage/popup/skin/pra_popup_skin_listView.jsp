						...
						<div class="widget-body " >
							...
							<div class="table-responsive">
								<jsp:include page="/WEB-INF/jsp/txap/include/search/pra_search_header_paging.jsp" flush="true">
									<jsp:param value="/txap/homepage/popupSkin/pagingAjax.do" name="pagingDataUrl" />
...
function pf_popupSkinUpdate(key, div) {
	...
	$("#Form").attr("action", "/txap/homepage/popupSkin/updateView.do");
	$("#Form").submit();
} 

//스킨관리 등록페이지 이동 
function pf_popupSkinRegist() {
	$("#Form").attr("action", "/txap/homepage/popupSkin/insertView.do");
	$("#Form").submit();
}
...
function pf_PublishFile(key){
	...
	if(confirm(msg)) {
		...
		$.ajax({
		    type   : "post",
		    url    : "/txap/homepage/popupSkin/publishAjax.do",
		    data   : {"PIS_KEYNO" : key},
		    async  : false ,
