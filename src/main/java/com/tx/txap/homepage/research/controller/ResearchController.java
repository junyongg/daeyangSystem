package com.tx.txap.homepage.research.controller;
...
public class ResearchController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/homepage/research/pageResearch.do")
	@CheckActivityHistory(desc="페이지 평가 페이지 방문")
	public ModelAndView pageResearch(HttpServletRequest req) throws Exception {
		ModelAndView mv  = new ModelAndView("/txap/homepage/research/pra_research_listView.adm");
	...
	public ModelAndView pageResearchPagingAjax(HttpServletRequest req,
		...
		ModelAndView mv  = new ModelAndView("/txap/homepage/research/pra_research_listView_data");
	...
	public ModelAndView pageResearchExcelAjax(HttpServletRequest req
		...
		ModelAndView mv  = new ModelAndView("/txap/homepage/research/pra_research_listView_excel");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/homepage/research/pageComment.do")
	@CheckActivityHistory(desc="코멘트 페이지")
	public ModelAndView pageComment(HttpServletRequest req) throws Exception {
		ModelAndView mv  = new ModelAndView("/txap/homepage/research/pra_comment_detail.adm");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/operation/pageResearch/commentDetail/pagingAjax.do")
	public ModelAndView commentDetailPagingAjax(HttpServletRequest req,
			Common search
			) throws Exception {
		
		ModelAndView mv  = new ModelAndView("/txap/homepage/research/pra_comment_detail_data");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/operation/pageResearch/commentDetail/excelAjax.do")
	public ModelAndView commentDetailExcelAjax(HttpServletRequest req
			, HttpServletResponse res
			, Common search
			) throws Exception {
		ModelAndView mv  = new ModelAndView("/txap/homepage/research/pra_comment_detail_excel");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/homepage/research/researchSkin.do")
	@CheckActivityHistory(desc="페이지평가 스킨관리 페이지 방문")
	public ModelAndView ResearchSkinView(HttpServletRequest req
			) throws Exception {
		ModelAndView mv  = new ModelAndView("/txap/homepage/research/skin/pra_research_skin_listView.adm");
		return mv;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/homepage/research/pagingAjax.do")
	public ModelAndView ResearchSkinViewPagingAjax(HttpServletRequest req,
			Common search
			) throws Exception {
		
		ModelAndView mv  = new ModelAndView("/txap/homepage/research/skin/pra_research_skin_listView_data");
	...
	@RequestMapping(value="/txap/homepage/research/updateView.do")
	...
	public ModelAndView ResearchSkinUpdateView(HttpServletRequest req
		...
		ModelAndView mv  = new ModelAndView("/txap/homepage/research/skin/pra_research_skin_insertView.adm");
		...
		mv.addObject("mirrorPage","/txap/homepage/research/researchSkin.do");
		mv.addObject("type","update");
		return mv;
	}
	
	@RequestMapping(value="/txap/homepage/research/insertView.do")
	...
	@RequestMapping(value = "/txap/homepage/research/insert.do")
	...
	public ModelAndView ResearchSkinInsert(ResearchSkinDTO ResearchSkinDTO,  HttpServletRequest req)
			throws Exception {
		ModelAndView mv = new ModelAndView("redirect:/txap/homepage/research/researchSkin.do");
	...
	@RequestMapping(value = "/txap/homepage/research/update.do")
	...
	@RequestMapping(value = "/txap/homepage/research/delete.do")
	...
	@RequestMapping(value = "/txap/homepage/research/publishAjax.do")
	@ResponseBody
	 ...
	 * 
	 */
	@RequestMapping(value = "/txap/homepage/research/skindataAjax.do")
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/research/returnPageAjax.do")
	@ResponseBody
	...
	@RequestMapping(value = "/txap/homepage/research/compareAjax.do")
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/homepage/research/useSkinAjax.do")
	@ResponseBody
