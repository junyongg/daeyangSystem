package com.tx.txap.admin.domain.controller;
...
public class AdmDomainController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value = "/txap/admin/domain.do")
	@CheckActivityHistory(desc = "서브도메인 관리 방문")
	public ModelAndView domain(
			HttpServletRequest req
			) throws Exception{
		ModelAndView mv = new ModelAndView("/txap/admin/domain/pra_domain_list.adm");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/admin/domain/pagingAjax.do")
	public ModelAndView domainPagingAjax(HttpServletRequest req,HttpServletResponse res,
			Common search
			) throws Exception {
		
		return AdmDomainService.paging("/txap/admin/domain/pra_domain_list_data",req,search);
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/admin/domain/excelAjax.do")
	public ModelAndView domainExcelAjax(HttpServletRequest req
		...
		return AdmDomainService.excel("/txap/admin/domain/pra_domain_list_excel",req,res,search);
		
	}
	
	@RequestMapping(value = "/txap/admin/domain/dataAajx.do")
	public ModelAndView domainDataAjax(
			HttpServletRequest req
			, @RequestParam(value="HM_KEYNO", defaultValue="") String HM_KEYNO
			) throws Exception{
		
		return AdmDomainService.data("/txap/admin/domain/pra_domain_insertView",HM_KEYNO);
		
		
	}
	
	@RequestMapping(value = "/txap/admin/domain/checkTilesNameAjax.do")
	@ResponseBody
	 ...
	 * 
	 */   					 
	@RequestMapping(value = "/txap/admin/domain/insertAjax.do")
	 ...
	 * 
	 */   					 
	@RequestMapping(value = "/txap/admin/domain/updateAjax.do")
	 ...
	 * 
	 */   					 
	@RequestMapping(value = "/txap/admin/domain/deleteAjax.do")
