...
<section id="widget-grid" class="">
	...
	<div class="row" >
		...
		<article class="col-xs-12 col-sm-12 col-md-12 col-lg-6" >
			...
			<form:form id="frm" name="frm" enctype="multipart/form-data" action="/txap/homepage/popup/insert.do?${_csrf.parameterName}=${_csrf.token}"  method="post">
				...
				<div class="form-actions">
					<div class="row">
						<div class="col-md-12">
							...
							<button class="btn btn-default" type="button" onclick="location.href='/txap/homepage/popup/popup.do'">
								취소
							</button>
						</div>
					</div>
...
<%@ include file="/WEB-INF/jsp/txap/include/_popup/pra_script_insertView.jsp" %>  
