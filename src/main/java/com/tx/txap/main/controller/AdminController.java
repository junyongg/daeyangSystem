package com.tx.txap.main.controller;
...
public class AdminController {
	...
	@RequestMapping(value="/txap/main/DataList/DataAjax.do")
	public ModelAndView mainBoardListAjax(
		...
		cookie.setPath("/txap/index.do");        //쿠키 접근 경로 지정
	...
	private ModelAndView getMainCategoryDataList(HttpServletRequest req, ModelAndView mv, String mainCategory, String homeKey,String STDT,String ENDT) {
		...
		switch (mainCategory) {
		case "board":
			mv.setViewName("/txap/main/pra_main_board");
			mv.addObject("boardlist",Component.getList("MainSQL.get_mainPageBoardList",homeKey));
			break;
		case "member":
			mv.setViewName("/txap/main/pra_main_member");
			...
			break;
		case "keyword":
			mv.setViewName("/txap/main/pra_main_keyword");
			break;
		case "satisfaction":
			mv.setViewName("/txap/main/pra_main_satisfaction");
			...
			break;
		case "menuCount":
			mv.setViewName("/txap/main/pra_main_menuCount");
			break;
		case "visitorCount":
			mv.setViewName("/txap/main/pra_main_visitorCount");
			break;
	 ...
	 * */
	@ResponseBody
	@RequestMapping(value="/txap/main/keywordCount/DataAjax.do")
	 ...
	 * */
	@ResponseBody
	@RequestMapping(value="/txap/main/menuCount/DataAjax.do")
	 ...
	 * */
	@ResponseBody
	@RequestMapping(value="/txap/main/visitorCount/DataAjax.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/setSiteAjax.do")
	@ResponseBody
