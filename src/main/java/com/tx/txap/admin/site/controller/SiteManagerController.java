package com.tx.txap.admin.site.controller;
...
public class SiteManagerController {
	...
	@RequestMapping(value = "/txap/admin/site.do")
	@CheckActivityHistory(desc = "사이트 관리 방문")
	public ModelAndView siteManagerView(
			HttpServletRequest req
			) throws Exception{
		ModelAndView mv = new ModelAndView("/txap/admin/site/pra_site_view.adm");
	...
	@RequestMapping(value = "/txap/admin/site/updateAjax.do")
	 ...
	 * @throws Exception
	 */ 
	@RequestMapping(value = "/txap/admin/site/distributeAjax.do")
