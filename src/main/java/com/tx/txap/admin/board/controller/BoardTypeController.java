...
public class BoardTypeController {
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/homepage/board/typeView.do")
	...
	public ModelAndView boardTypeView(HttpServletRequest req
		...
		ModelAndView mv  = new ModelAndView("/txap/homepage/board/type/pra_board_type_listView.adm");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/homepage/board/typeView/pagingAjax.do")
	public ModelAndView boardTypeViewPagingAjax(HttpServletRequest req,
			Common search
			) throws Exception {
		
		ModelAndView mv  = new ModelAndView("/txap/homepage/board/type/pra_board_type_listview_data");
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/homepage/board/typeView/excelAjax.do")
	public ModelAndView boardTypeViewExcelAjax(HttpServletRequest req
			, HttpServletResponse res
			, Common search
			) throws Exception {
		ModelAndView mv  = new ModelAndView("/txap/homepage/board/type/pra_board_type_listview_excel");
	...
	@RequestMapping(value="/txap/homepage/board/type/actionView.do")
	...
	public ModelAndView BoardInsertView(
		...
		ModelAndView mv  = new ModelAndView("/txap/homepage/board/type/pra_board_type_insertView.adm");
		...
		mv.addObject("mirrorPage","/txap/homepage/board/typeView.do");
		mv.addObject("action",action);
		return mv;
	}
	
	
	@RequestMapping(value="/txap/homepage/board/type/action.do")
	@CheckActivityHistory(type = "hashmap", homeDiv = SettingData.HOMEDIV_ADMIN)
	@Transactional
	public ModelAndView BoardUpdate(@ModelAttribute BoardType BoardType
		...
		ModelAndView mv  = new ModelAndView("redirect:/txap/homepage/board/typeView.do");
	...
	@RequestMapping(value = "/txap/homepage/board/type/updateView/listAjax.do")
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/homepage/board/type/delete.do")
	...
	@RequestMapping(value="/txap/homepage/board/type/SkinDataSearch.do")
	@ResponseBody
