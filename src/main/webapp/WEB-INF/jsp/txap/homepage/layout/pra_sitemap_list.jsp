			...
			<div class="jarviswidget jarviswidget-color-darken" id="wid-id-0"
				...
				<div>
					...
					<div class="widget-body">
						...
						<form:form id="Form" method="post" action="/txap/homepage/layout/sitemap.do">
...
function pf_Distribute(){ 
	...
	var url = '/txap/homepage/common/sitemap/distributeAjax.do'
...
function pf_fileDelete() {
	var url = '/txap/homepage/common/sitemap/fileDelete.do'
