...
import com.tx.txap.admin.board.dto.BoardHtml;
...
public class BoardHtmlController {
	...
	@RequestMapping(value = "/txap/homepage/board/data/html/insertView.do")
	...
	public ModelAndView BoardHtmlInsertView(HttpServletRequest req, @ModelAttribute Menu Menu,
		...
		ModelAndView mv = new ModelAndView("/txap/homepage/board/html/pra_board_html_insertView.adm");
	...
	@RequestMapping(value = "/txap/homepage/board/data/html/insert.do")
	...
	public ModelAndView BoardHtmlInsert(@ModelAttribute BoardHtml BoardHtml, HttpServletRequest req) throws Exception {
		ModelAndView mv = new ModelAndView("redirect: /txap/homepage/board/dataView.do?MN_KEYNO=" + BoardHtml.getBIH_MN_KEYNO());
	...
	@RequestMapping(value = "/txap/homepage/board/data/html/update.do")
	...
	@RequestMapping(value = "/txap/homepage/board/data/html/delete.do")
