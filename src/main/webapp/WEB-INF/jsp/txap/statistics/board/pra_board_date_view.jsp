				...
				<div class="jarviswidget jarviswidget-color-blueDark" id="board_notice_list_1" data-widget-editbutton="false">
					...
					<div>
						...
						<div class="widget-body">
							...
							<form:form id="Form" name="Form" method="post" action="/txap/operation/serchpageview.do?${_csrf.parameterName}=${_csrf.token}" class="smart-form" role="form">
																...
																<tr>
																	<th colspan="33">
																		<div style="float:right;">
																			<button type="button" class="btn btn-sm btn-default" onclick="pf_excel('/txap/func/AttachDetailExcel.do')">엑셀</button>
																	    </div>
																	</th>
																</tr>
																<tr>
...
function getHtml() {
	$.ajax({
		type : "post",
		data : $('#Form').serialize(),
		url : "/txap/func/AjaxattachDetailView.do",
		async : false,
...
function pf_back(){
	location.href="/txap/func/attachments.do";
}
