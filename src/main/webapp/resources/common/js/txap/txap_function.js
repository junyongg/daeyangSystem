...
function af_boardDetailView(keyOrKeyno, isNewWindow){
	...
	var goUrl = '/txap/homepage/board/data/detailView.do?BN_KEYNO=' + keyOrKeyno;
	if( isNewWindow ){
		window.open(goUrl)
	}else{
		location.href = goUrl;
	}
	// /txap/homepage/board/data/detailView.do?BT_KEYNO=BT_0000000000&BN_KEYNO=BN_0000000000&MN_HOMEDIV_C=MN_0000000000&MN_KEYNO=MN_0000000000
}
