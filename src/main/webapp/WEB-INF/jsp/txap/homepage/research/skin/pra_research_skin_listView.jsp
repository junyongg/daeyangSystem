						...
						<div class="widget-body " >
							...
							<div class="table-responsive">
								<jsp:include page="/WEB-INF/jsp/txap/include/search/pra_search_header_paging.jsp" flush="true">
									<jsp:param value="/txap/homepage/research/pagingAjax.do" name="pagingDataUrl" />
...
function pf_researchSkinUpdate(key) {
	$("#PRS_KEYNO").val(key);
	$("#Form").attr("action", "/txap/homepage/research/updateView.do");
	$("#Form").submit();
} 

//스킨관리 등록페이지 이동 
function pf_researchSkinRegist() {
	$("#Form").attr("action", "/txap/homepage/research/insertView.do");
	$("#Form").submit();
}
...
function pf_PublishFile(key){
	...
	if(confirm(msg)) {
		...
		$.ajax({
		    type   : "post",
		    url    : "/txap/homepage/research/publishAjax.do",
		    data   : {"PRS_KEYNO" : key},
		    async  : false ,
