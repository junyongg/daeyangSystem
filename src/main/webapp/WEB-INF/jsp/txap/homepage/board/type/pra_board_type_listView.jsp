...
<div id="content">
	<form:form id="Form" name="Form" method="post" action="/txap/homepage/board/type/actionView.do">
						...
						<div class="widget-body " >
							...
							<div class="table-responsive">
								<jsp:include page="/WEB-INF/jsp/txap/include/search/pra_search_header_paging.jsp" flush="true">
									<jsp:param value="/txap/homepage/board/typeView/pagingAjax.do" name="pagingDataUrl" />
...
function pf_boardTypeAction(type, key) {
	$("#Form").attr("action","/txap/homepage/board/type/actionView.do");
	if(key){
		$("#BT_KEYNO").val(key);
	}
	$("#action").val(type);
