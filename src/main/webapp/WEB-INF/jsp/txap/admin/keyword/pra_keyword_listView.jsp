									...
									<div class="tab-content padding-10">
										<div class="table-responsive">
											<jsp:include page="/WEB-INF/jsp/txap/include/search/pra_search_header_paging.jsp" flush="true">
												<jsp:param value="/txap/admin/keyword/pagingAjax.do" name="pagingDataUrl" />
												<jsp:param value="/txap/admin/keyword/excelAjax.do" name="excelDataUrl" />
											</jsp:include>
...
function pf_openKeywordList(obj){
	...
	$.ajax({
		type: "POST",
		url: "/txap/admin/keyword/detailListAjax.do",
...
function pf_deleteKeywordDetail(keyword,ip,date,id,obj){
	...
	$.ajax({
		type: "POST",
		url: "/txap/admin/keyword/deleteAjax.do",
...
function pf_deletekeyword(obj){
	...
	$.ajax({
		type: "POST",
		url: "/txap/admin/keyword/deleteKeywordAjax.do",
		data: "SK_KEYWORD="+encodeURI(KEYWORD),
		async:false,
		success : function(){
			alert('정상적으로 삭제되었습니다.');
...
function pf_updatekeyword(){
	...
	$('#Form').attr('action','/txap/admin/keyword/update.do');
	$('#Form').submit();
