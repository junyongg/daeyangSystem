package com.tx.txap.admin.code.controller;
...
import com.tx.txap.admin.code.dto.MainCode;
import com.tx.txap.admin.code.dto.SubCode;
...
public class AdminCodeController {
	...
	// 상위 코드 목록 페이지 호출
	@RequestMapping(value = "/txap/admin/code.do")
	...
	public String GetMainCodeList(Model model) throws Exception {
		...
		return "/txap/admin/code/pra_code_view.adm";
	}
	...
	public String GetSubCodeList(@ModelAttribute("MC_IN_C")String MC_IN_C, 
		...
		model.addAttribute("mirrorPage", "/txap/admin/code.do");
		return "/txap/admin/code/pra_subcode_view.adm";
	}
	
	// 상위 코드 등록 페이지 호출
	@RequestMapping(value = "/txap/admin/code/sub/insertView.do")
	...
	public String GetMainCodeListRegist(@ModelAttribute("MC_IN_C")String MC_IN_C, Model model) throws Exception {
		...
		model.addAttribute("mirrorPage", "/txap/admin/code.do");
		return "/txap/admin/code/pra_code_regist.adm";
	}
		

	// 상위 코드 등록 작업
	@RequestMapping(value = "/txap/admin/code/main/insert.do")
	...
	public String InsertMainCodeRegist(
		...
		return "redirect:/txap/admin/code.do";
	}	
		
	
	// 메인코드 수정하기 
	@RequestMapping(value = "/txap/admin/code/main/update.do")
	...
	// 메인코드 삭제하기 
	@RequestMapping(value = "/txap/admin/code/main/delete.do")
	...
	// 서브코드 삭제 하기 
	@RequestMapping(value = "/txap/admin/code/sub/deleteAjax.do")
	...
	// 서브코드 수정하기 
	@RequestMapping(value = "/txap/admin/code/sub/updateAjax.do")
	...
	//서브코드 등록하기
	@RequestMapping(value = "/txap/admin/code/sub/insertAjax.do")
