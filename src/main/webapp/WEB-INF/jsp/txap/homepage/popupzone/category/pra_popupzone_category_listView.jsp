						...
						<div class="widget-body " >
							...
							<div class="table-responsive">
								<jsp:include page="/WEB-INF/jsp/txap/include/search/pra_search_header_paging.jsp" flush="true">
									<jsp:param value="/txap/homepage/popupzone/pagingAjax.do" name="pagingDataUrl" />
...
function pf_categoryUpdate(key) {
	$("#TCGM_KEYNO").val(key);
	$("#Form").attr("action", "/txap/homepage/popupzone/updateView.do");
	$("#Form").submit();
} 

//카테고리 등록페이지 이동 
function pf_categoryRegist() {
	$("#Form").attr("action", "/txap/homepage/popupzone/insertView.do");
	$("#Form").submit();
}
...
function pf_CreateFile(key){
		...
		$.ajax({
		    type   : "post",
		    url    : "/txap/homepage/popupzone/createFileAjax.do",
		    data   : {"TCGM_KEYNO" : key},
		    async  : false ,
