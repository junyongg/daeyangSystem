...
<script>
	...
	function pf_addURL(){
		...
		$('#form').attr('action', '/txap/admin/ipfilter/main/insert.do');
		$('#form').submit();
	}
	...
	function pf_removeURL(obj, KEYNO){
		...
		if(confirm('정말 삭제하시겠습니까?')){
			...
			$.ajax({
				type: "POST",
				url: "/txap/admin/ipfilter/main/deleteAjax.do",
	...
	function pf_UpdateURL(){
		...
		$.ajax({
			type: "POST",
			url: "/txap/admin/ipfilter/main/updateAjax.do",
			data: $('#form').serializeArray(),
			async:false,
			success : function(){
				alert('정상적으로 수정되었습니다.');
	...
	function getIPList(obj, KEYNO,TYPE_NAME){
		...
		$.ajax({
			type: "POST",
			url: "/txap/admin/ipfilter/subList/listAjax.do?KEYNO="+KEYNO+"&TYPE="+TYPE,
			data: $('#form').serializeArray(),
			async:false,
	...
	function pf_addAddress(type, id) {
		...
		$('#form').attr('action', '/txap/admin/ipfilter/sub/insert.do');
		$('#form').submit();
	...
	function pf_removeAddress(type, obj, IPS_KEYNO) {
		...
		$.ajax({
			type: "POST",
			url: "/txap/admin/ipfilter/sub/deleteAjax.do",
			data: $('#form').serializeArray(),
			success : function(){
				 alert('정상적으로 삭제되었습니다.')
				 $(obj).parents('tr').remove();
	...
	function pf_UpdateAddress(){
		...
		$.ajax({
			type: "POST",
			url: "/txap/admin/ipfilter/sub/updateAjax.do",
			data: $('#form').serializeArray(),
			async:false,
			success : function(){
				alert('정상적으로 수정되었습니다.')
