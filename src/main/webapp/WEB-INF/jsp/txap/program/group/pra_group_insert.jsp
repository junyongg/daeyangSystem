...
function pf_programAction(type){
	...
	if(confirm(type+'하시겠습니까?')){
		...
		cf_replaceTrim($("#Form"));
 		$("#Form").attr("action", "/txap/program/group/action.do");
		$("#Form").submit();
	     }
	}
}
...
<form:form id="Form" action="/txap/program/group/action.do">
			...
			<div class="jarviswidget jarviswidget-color-blueDark" id="wid-id-0"
				...
				<div  class="smart-form">
					...
					<footer class="padding-10 text-right"> 
						<button class="btn btn-sm btn-default" id="Insert_Cencle" type="button" onclick="cf_back('/txap/program/group/program.do');"> 
