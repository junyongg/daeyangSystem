package com.tx.txap.homepage.menu.controller;
...
import com.tx.txap.operation.qrcode.service.QrCodeService;
...
public class AdminMenuManager {
	 ...
	 * 
	 */   
	@RequestMapping(value = {"/txap/homepage/menumanage/menu.do","/txap/admin/menu.do"})
	...
	public String MenuManagerView(HttpServletRequest request,Model model,Menu Menu) throws Exception{ 
		...
		if("/txap/admin/menu.do".equals(request.getRequestURI()) ) {
	 ...
	 * 
	 */   
	@RequestMapping(value = "/txap/homepage/menuListAjax.do")
	 ...
	 * 
	 */
	@RequestMapping(value = "/txap/homepage/menu/menuManagerAjax.do")
	public ModelAndView MenuManagerAjax(
		...
		ModelAndView mv = new ModelAndView("/txap/homepage/menu/pra_menu_insert");
	 ...
	 * 
	 */
	@RequestMapping(value = "/txap/homepage/menu/menuDethMoveAjax.do")
	 ...
	 * @param 단일 QR초기화
	 */
	@RequestMapping(value = "/txap/user/QRcodeAjax.do")
	@ResponseBody
	 ...
	 * @param 천체 QR초기화
	 */
	@RequestMapping(value = "/txap/user/AllQRcodeAjax.do")
	@ResponseBody
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/homepage/menumanage/template.do")
	@CheckActivityHistory(desc="메뉴관리 - 메뉴 템플릿관리 방문")
	public ModelAndView MenuTemplate(HttpServletRequest req
			) throws Exception {
		ModelAndView mv  = new ModelAndView("/txap/homepage/menu/menutemplate/pra_menu_template_listView.adm");
		return mv;
	}
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/txap/homepage/menumanage/template/pagingAjax.do")
	public ModelAndView MenuTemplatePagingAjax(HttpServletRequest req,
			Common search
			) throws Exception {
		
		ModelAndView mv  = new ModelAndView("/txap/homepage/menu/menutemplate/pra_menu_template_listview_data");
	...
	@RequestMapping(value="/txap/homepage/menumanage/template/actionView.do")
	...
	public ModelAndView MenuTemplateInsertView(HttpServletRequest req,
		...
		ModelAndView mv  = new ModelAndView("/txap/homepage/menu/menutemplate/pra_menu_template_insertView.adm");
		...
		mv.addObject("mirrorPage","/txap/homepage/menumanage/template.do");
		return mv;
	}
	

	
	@RequestMapping(value = "/txap/homepage/menumanage/template/action.do")
	@CheckActivityHistory(type = "hashmap", homeDiv = SettingData.HOMEDIV_ADMIN)
	@Transactional
	public ModelAndView MenuTemplateInsert(MenuHeaderTemplate MenuHeaderTemplate,  HttpServletRequest req,
			 @RequestParam(value="action", required=false) String action )
			throws Exception {
		ModelAndView mv = new ModelAndView("redirect:/txap/homepage/menumanage/template.do");
	...
	@RequestMapping(value = "/txap/homepage/menumanage/template/delete.do")
	...
	@RequestMapping(value = "/txap/homepage/menumanage/template/publishAjax.do")
	@ResponseBody
